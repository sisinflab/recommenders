...
public class MainBPR {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println( "" );
        System.out.println( "" );
        System.out.println( "Soft Margin Ranking Matrix Factorization algorithm" );
        System.out.println( "This implementation was realized using Oracle Java 8" );
        System.out.println( "Usage: java -jar SoftMarginRankingMF algorithm fileVotes fileRecs numberOfFactors numberOfRecs" );
